            ...
            <div id="headline">
                <div id="headline_content">
                  <?php
                   ...
                   ?>
                    <span>-  Total Items: <?php items(); ?> - Total Price: KSH <?php total_price(); ?><a href="cart.php" style="color:yellow;"> Go to Cart</a></span>
    ...
    <footer>
      <div class="footer_wrap">
        ...
        <div class="copyright_link">
          <span>&copy; 2020-2022 Furniture House</span>
        </div>
      </div>
    </footer>
