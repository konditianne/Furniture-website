            ...
            <div id="headline">
                <div id="headline_content">
                  <?php
                   ...
                   ?>
                    <span>-  Total Items: <?php items(); ?> - Total Price: KSH <?php total_price(); ?><a href="all_products.php" style="color:yellow;"> Back to Shopping</a>
                    </span>
                        ...
                        <tr>
                            ...
                            <?php
                                if(isset($_POST['update']))
                                {
                                  ...
                                  $insert_qty="update cart set qty='KSHqty' where ip_add='$ip_add'";
                                  $run_qty=mysqli_query($con,$insert_qty);
                                  $total=$total*$qty;
                                  echo "<td><input type='text' name='qty' value='KSHqty' size='3'/></td>";
                                }

                             ?>
                            <td><?php echo "KSH ".$only_price; ?></td>
                        </tr>
                      <?php }} ?>
                      <tr>
